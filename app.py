...
try:
    ...
    # تعريف دوال بديلة لمنع الأخطاء
    def show_appointments():
        st.error("ملف المواعيد غير موجود")
    def show_financial_dashboard():
        st.error("ملف التقارير المالية غير موجود")
    def show_accounting():
        st.error("ملف المحاسبة غير موجود")
    def show_doctors_management():
        st.error("ملف الأطباء غير موجود")
    def show_patients_management():
        st.error("ملف المرضى غير موجود")
    def show_inventory_management():
        st.error("ملف المخزون غير موجود")
...
def show_dashboard():
    ...
    try:
        ...
        with col7:
            ...
            st.metric("⚠️ عناصر قليلة", len(low_stock) if not low_stock.empty else 0)
        ...
        with col9:
            ...
            if not low_stock_items.empty:
                ...
                st.success("✅ لا توجد عناصر تحت مستوى المخزون الأدنى")
        ...
        with col10:
            ...
            if not expired_items.empty:
                ...
                st.success("✅ لا توجد عناصر منتهية الصلاحية")
        ...
        with col11:
            ...
            if not doctors_performance.empty:
                ...
                st.info("لا توجد بيانات عن الأطباء")
